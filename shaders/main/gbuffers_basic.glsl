...
uniform mat4 gbufferModelViewInverse;
    ...
    void main(){
        ...
        // Lightmap fix for mods, use ((gl_TextureMatrix[1] * gl_MultiTexCoord1).xy - 0.03125) * 1.06667 to remap it to 0-1// Lightmap fix for mods, use ((gl_TextureMatrix[1] * gl_MultiTexCoord1).xy - 0.03125) * 1.06667 to remap it to 0-1
